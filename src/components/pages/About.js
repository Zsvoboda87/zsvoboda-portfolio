...
export default function About() {
    return (
        <div className='about-parent flex-column'>
            ...
            <div className='about flex-column'>
                ...
                <p className='vw80'>
                    ...
                    Technical skills include HTML, CSS, ES6, Node JS, React, MySql, MongoDb and more.  Zachary is constantly seeking new and
