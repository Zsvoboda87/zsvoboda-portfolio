    ...
    return (
        <div className='flex-evenly'>
            <a className='nav-link vw43' href="https://powerful-basin-06230.herokuapp.com/">
                ...
                <img className="vw43" src="assets/images/Curb-Alert.jpeg" alt="Curb Alert Webpage cover"></img>
            </a>
            ...
            <a className='nav-link vw43' href="https://zsvoboda87.github.io/Bored-AF/">
                <h3>Bored-AF <a className='nav-link' href='https://github.com/Zsvoboda87/Bored-AF'>Github</a></h3>
            ...
            <a className='nav-link vw43' href="https://watch.screencastify.com/v/2JGX16nUDU8GSKy7FYw2">
                <h3>SQl Employee Tracker <a className='nav-link' href='https://github.com/Zsvoboda87/SQL-Employee-Tracker'>Github</a></h3>
            ...
            <a className='nav-link vw43' href="https://young-temple-73421.herokuapp.com/">
                <h3>The Nerd Spot <a className='nav-link' href='https://github.com/Zsvoboda87/The-Nerd-Spot'>Github</a></h3>
            ...
            <a className='nav-link vw43' href="https://stark-badlands-84312.herokuapp.com/">
                <h3>Pizza Hunt <a className='nav-link' href='https://github.com/Zsvoboda87/pizza-hunt'>Github</a></h3>
            ...
            <a className='nav-link vw43' href="https://zsvoboda87.github.io/Portfolio/">
                <h3>Portfolio 1 <a className='nav-link' href='https://github.com/Zsvoboda87/Portfolio'>Github</a></h3>
                <h5>HTML, CSS</h5>
